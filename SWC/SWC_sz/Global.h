...
public:
    ...
    static bool isCommunicationOpened[MAX_CONNECTOR];
    ...
    static bool isHardwareThere[MAX_CONNECTOR];
    static int HardwareThereCount[MAX_CONNECTOR];
    ...
    static bool isResetNow[MAX_CONNECTOR];
};
